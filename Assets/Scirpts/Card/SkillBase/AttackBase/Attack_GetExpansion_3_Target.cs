...
public sealed class Attack_GetExpansion_3_Target : AttatkBase
{
    public Attack_GetExpansion_3_Target(AbilityNeedData data) : base(data)
    {
    }
