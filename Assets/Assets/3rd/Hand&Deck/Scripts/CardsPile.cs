...
public class CardsPile : MonoBehaviour
{
	...
	//public List<GameObject> Cardss { get { return cards; } }
	...
	public Transform TMPTransform { get; private set; }
	...
	//[ServerRpc]
	//Transform GetCardHolderServerRpc()
	//{
	//	//Transform cardHolder = Instantiate(cardHolderPrefab, transform, false);
	//	var cardHolder = Instantiate(cardHolderPrefab);
	//	var N = cardHolder.GetComponent<NetworkObject>();
	//	N.SpawnWithOwnership(MyPlayerUser.OwnerClientId, true);
