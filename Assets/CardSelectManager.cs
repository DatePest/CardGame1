...
public class CardSelectManager : MonoBehaviour
{
    ...
    public void SelectReturn_2(int G, CardDisplay_TopreturnSelect Obj , int TagN)
    {

        if(TagN == -1)
        {
            SelectArray[CurrntTag] = G;
        ...
        if (SelectArray[SelectArray.Length - 1] == null) return;
        SelectList.Clear();
        for (int i=0;i< SelectArray.Length; i++)
        {
