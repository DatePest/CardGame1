...
public class MapArea : NetworkBehaviour
{
    /// <summary>
    /// 6,7,8
    /// 3,4,5
    ...
    int Row = 3;//x
    int Column = 3;//y
    public ulong PlayerOwnerID { get; private set; } = new();
    ...
    [ServerRpc]
    public void SetPlayerOwnerNumberID_ServerRpc(ulong ID)
    {
        SetPlayerOwnerNumberID_ClientRpc(ID);
    }
    [ClientRpc]
    public void SetPlayerOwnerNumberID_ClientRpc(ulong ID)
    {
        PlayerOwnerID = ID;
